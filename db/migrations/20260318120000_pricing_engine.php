...
class PricingEngine extends AbstractMigration
{
    public function change()
    {
        ...
        if (!$this->hasTable('pricing_tiers')) {
            ...
            $table->addColumn('asset_type_id', 'integer', ['signed' => false, 'null' => false])
                ->addColumn('min_days', 'integer', ['signed' => false, 'null' => false])
                ->addColumn('max_days', 'integer', ['signed' => false, 'null' => true])
        ...
        if (!$this->hasTable('pricing_volume_discounts')) {
            ...
            $table->addColumn('min_quantity', 'integer', ['signed' => false, 'null' => false])
                ->addColumn('max_quantity', 'integer', ['signed' => false, 'null' => true])
        ...
        if (!$this->hasTable('pricing_seasonal_surcharges')) {
            ...
            $table->addColumn('name', 'string', ['limit' => 100, 'null' => false])
                ->addColumn('start_month', 'integer', ['signed' => false, 'null' => false])
                ->addColumn('start_day', 'integer', ['signed' => false, 'null' => false])
                ->addColumn('end_month', 'integer', ['signed' => false, 'null' => false])
                ->addColumn('end_day', 'integer', ['signed' => false, 'null' => false])
        ...
        if (!$this->hasTable('pricing_bundle_items')) {
            ...
            $table->addColumn('bundle_id', 'integer', ['signed' => false, 'null' => false])
                ->addColumn('asset_type_id', 'integer', ['signed' => false, 'null' => false])
        ...
        if (!$this->hasTable('pricing_customer_lists')) {
            ...
            $table->addColumn('client_id', 'integer', ['signed' => false, 'null' => false])
        ...
        if (!$this->hasTable('pricing_customer_list_items')) {
            ...
            $table->addColumn('list_id', 'integer', ['signed' => false, 'null' => false])
                ->addColumn('asset_type_id', 'integer', ['signed' => false, 'null' => false])
