...
class TransportLogistics extends AbstractMigration
{
    public function change()
    {
        ...
        if (!$this->hasTable('transport_vehicles')) {
        ...
        // Transport drivers
        if (!$this->hasTable('transport_drivers')) {
        ...
        if (!$this->hasTable('transport_tours')) {
        ...
        if (!$this->hasTable('transport_tour_stops')) {
        ...
        if (!$this->hasTable('transport_costs')) {
