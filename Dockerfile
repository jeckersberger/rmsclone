...
LABEL org.opencontainers.image.description="MyRMS is an advanced Rental Management System for Theatre, AV & Broadcast. This image is a PHP Apache2 docker container, which exposes MyRMS on port 80."
