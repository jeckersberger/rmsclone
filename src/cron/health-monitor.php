...
if (!empty($alerts)) {
    ...
    $html  = "<h2>AdamRMS Health Alert - " . date('Y-m-d H:i:s') . "</h2>";
    ...
    $html .= "</table>";
    $html .= "<p style='margin-top:16px;color:#6c757d;font-size:0.9em;'>This alert was generated by the AdamRMS health monitor cron job.</p>";
    ...
    if ($alertEmail) {
        ...
        $subject = "[{$highestLevel}] AdamRMS Health Alert: " . count($alerts) . " issue(s)";
