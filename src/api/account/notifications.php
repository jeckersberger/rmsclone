<?php
	...
	if ($_POST['users_userid'] !== (string)$AUTH->data["users_userid"] && $AUTH->serverPermissionCheck("USERS:EDIT:NOTIFICATION_SETTINGS")) $userid = $bCMS->sanitizeString($_POST['users_userid']);
