...
if (isset($_POST['assetTypes_id'])) {
    ...
    $DBLIB->where("(instances_id IS NULL or instances_id = ?)", [(int)$_POST['new_instances_id']]);
...
$bCMS->auditLog("TRANSFER-ASSET", "assets", "Asset moved from instance " . $AUTH->data['instance']["instances_id"] . " to " . (int)$_POST['new_instances_id'] . " instance - new id " . $asset['assets_id'], $AUTH->data['users_userid']);
